...
### Install in One Click (Recommended)

The easiest way to install the mod is using **[Vortex](https://www.nexusmods.com/about/vortex/)** (or r2modman/Thunderstore).

Just click the **Vortex** button on the Nexus page — the manager will handle everything automatically. No manual file copying required!
